...
| Architecture draft | Done | Complete technical architecture document with figures and PDF/HTML export. | Done | docs/01_architecture_overview.md, docs/figures/architecture/, outputs/Fragment_Autocomplete_Architecture_Draft.pdf or .html | Review with Anna, Jeremy, SUB Göttingen, and Fragmentarium collaborators. |
| Database schema draft | Done or In progress | Initial entities and storage plan described. | In progress | Architecture document database section | Create concrete PostgreSQL/PostGIS schema and migrations. |
