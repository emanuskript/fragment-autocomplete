  ...
  for manuscript in corpus_manifest.get("manuscripts", []):
    for page in manuscript.get("pages", []):
      ...
      selected_inputs.append({
        ...
        "canvas_identifier": page.get("canvas_identifier"),
        ...
        "db_manuscript_id": db_ids.get("manuscript_id"),
        "db_repository_id": db_ids.get("repository_id"),
        "db_manifest_cache_id": db_ids.get("manifest_cache_id"),
        "db_fragment_id": None,
        "rights_review_status": image["rights_review_status"],
        "training_allowed": image["training_allowed"],
        "rights_statement": image.get("rights_statement"),
