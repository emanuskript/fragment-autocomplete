...
required_files=(
  ...
  "docs/16_training_corpus_validation_decision_audit.md"
  "docs/17_training_corpus_expansion_batch_01.md"
  "docs/18_training_corpus_expansion_batch_01_segmentation.md"
  ...
  "data/metadata/training_corpus_expansion_batch_01_spec.yaml"
  "data/metadata/training_corpus_expansion_batch_01_manifest.yaml"
  "data/metadata/training_corpus_expansion_batch_01_statistics.yaml"
  "data/metadata/training_corpus_expansion_batch_01_validation.yaml"
  "data/metadata/training_corpus_expansion_batch_01_acquisition_validation.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_spec.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_inputs.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_results.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_storage_results.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_source_snapshot.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_mask_snapshot.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_statistics.yaml"
  "data/metadata/training_corpus_expansion_batch_01_segmentation_validation.yaml"
  "data/metadata/training_corpus_expansion_readiness_review.yaml"
  "data/metadata/training_corpus_validation_decision_audit.yaml"
  ...
  "scripts/validate_training_corpus_expansion_batch.sh"
  "scripts/validate_training_corpus_expansion_batch.py"
  "scripts/validate_training_corpus_expansion_batch_01_acquisition.sh"
  "scripts/validate_training_corpus_expansion_batch_01_acquisition.py"
  "scripts/prepare_training_corpus_segmentation_inputs.py"
  "scripts/run_training_corpus_expansion_batch_01_segmentation.sh"
  "scripts/validate_training_corpus_expansion_batch_01_segmentation.py"
  ...
  "tests/ingestion/test_iiif_ingest_rights.py"
  "tests/ingestion/test_training_corpus_expansion_batch_01_acquisition.py"
  ...
  "tests/evaluation/test_training_corpus_expansion_batch_01_segmentation.py"
